...
<!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
          <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                ...
                <div class="sm:flex items-center justify-between">
                    <div class="flex items-center">
                        <a class="rounded-full focus:outline-none focus:ring-2  focus:bg-indigo-50 focus:ring-indigo-800" href=" javascript:void(0)">
                            <div class="py-2 px-8 bg-indigo-100 text-indigo-700 rounded-full" @click="showPeople">
                        ...
                        <a class="rounded-full focus:outline-none focus:ring-2 focus:bg-indigo-50 focus:ring-indigo-800 ml-4 sm:ml-8" href="javascript:void(0)">
                            <div class="py-2 px-8 text-gray-600 hover:text-indigo-700 hover:bg-indigo-100 rounded-full " @click="vehiclesShow">
                                <p>Vehicle Entered</p>
                            </div>
                        </a>
                    </div>
                    <button onclick="popuphandler(true)" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3 bg-indigo-700 hover:bg-indigo-600 focus:outline-none rounded" @click="sendNotif">
                        <p class="text-sm font-medium leading-none text-white">Send Notification</p>
                    </button>
                </div>
                <div class="mt-7 overflow-x-auto">
                    <table class="w-full whitespace-nowrap">
                        <tbody>
                            ...
                            v-for="dataRec in enteredVehicleList" :key="dataRec.id">
                                <td>
                                </td>
                                <td class="">
                                    <div class="flex items-center pl-5">
                                        <p class="text-base font-medium leading-none text-gray-700 mr-2">{{dataRec.name}}</p>
                                ...
                                <td class="pl-24">
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-sm leading-none text-gray-600 ml-2">Entered Date</p>
                                    </div>
                                </td>
                                <td class="pl-5">
                                    <div class="flex items-center">
                                        <p class="text-sm leading-none text-gray-600 ml-2">{{dataRec.month + " " + dataRec.day + ", " + dataRec.year}}</p>
                                    </div>
                                </td>
                                <td class="pl-5">
                                </td>
                                <td class="pl-5">
                                    <div class="flex items-center">
                                        <p class="text-sm leading-none text-gray-600 ml-2">Entered @</p>
                                    </div>
                                </td>
                                <td class="pl-5">
                                    <button class="py-3 px-3 text-sm focus:outline-none leading-none text-red-700 bg-red-100 rounded">{{ dataRec.visitedEstab }}</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
              ...
              <div v-if="vehicleShow">
                    ...
                    <div class="flex items-center">
                        <a class="rounded-full focus:outline-none focus:ring-2  focus:bg-indigo-50 focus:ring-indigo-800" href=" javascript:void(0)">
                            <div class="py-2 px-8 text-gray-600 hover:text-indigo-700 hover:bg-indigo-100 rounded-full" @click="showPeople">
                                <p>Contacted Person</p>
                            </div>
                        </a>
                        <a class="rounded-full focus:outline-none focus:ring-2 focus:bg-indigo-50 focus:ring-indigo-800 ml-4 sm:ml-8" href="javascript:void(0)">
                            <div class="py-2 px-8 bg-indigo-100 text-indigo-700 rounded-full " @click="vehiclesShow">
                                <p>Vehicle Entered</p>
                            </div>
                        </a>
                    </div>
                ...
                <div class="mt-7 overflow-x-auto">
                    <table class="w-full whitespace-nowrap">
                        <tbody>
                            <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded" 
                            v-for="dataRec in listPeople" :key="dataRec.id">
                                <td>
                                </td>
                                <td class="">
                                    <div class="flex items-center pl-5">
                                ...
                                <td class="pl-5">
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-sm leading-none text-gray-600 ml-2">{{dataRec.address}}</p>
                                    </div>
                                </td>
                                <td class="pl-5">
                                    <div class="flex items-center">
                                ...
                                <td class="pl-5">
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-sm leading-none text-gray-600 ml-2">{{dataRec.phoneNumber}}</p>
                                    </div>
                                </td>
                                <td class="pl-5">
                                    <button class="py-3 px-3 text-sm focus:outline-none leading-none text-red-700 bg-red-100 rounded">{{dataRec.month + dataRec.day + ", " + dataRec.year}}</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
export default {
  ...
  methods: {
    ...
    async findRoute() {
      ...
      this.$data.notification.header = "You have contacted a confirm COVID-19 Positive"
      this.$data.notification.notificationMessage =
        "You have encountered an Confirm Covid-19 Positive patient @" +  this.$data.report.monthTested +
        " " +
        this.$data.report.dayTested +
        ", " +
        this.$data.report.yearTested + "Upon entering the establishment";
