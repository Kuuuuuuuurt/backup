    ...
    async sendNotif() {
      ...
      for (let i = 0; i < this.peopleNo.length; i++) {
        ...
        this.$data.notification.notificationMessage =
          ...
          " ikaw ay nakasakay sa isang balik-balik na may driver na confirmed Covid-19 Positive. Hinihikayat ka namin na mag-self quarantine kaagad.";
