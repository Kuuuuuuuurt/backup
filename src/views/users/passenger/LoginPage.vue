      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="p-6 text-center">
            ...
            >
              {{"User " + user.userInfo.firstName + " " + user.userInfo.lastName + " is already Logged in. Please type the password to confirm and continue."}}
            </h3>
...
export default {
  ...
  methods: {
    ...
    toregister() {
      this.$router.push("/passenger/verify-user");
    },
    estab() {
    ...
    forgotPassword(){
      this.$router.push("/passenger/forgot-pass")
    },
    ...
    alreadyLogin(){
     const auth = getAuth(app);
      ...
      const phoneEmail = this.$data.user.userInfo.phoneNumber + "@gmail.com";
      const password = this.$data.alreadyPassword;
       ...
       signInWithEmailAndPassword(auth, phoneEmail, password)
        .then(() => {
          ...
          this.$data.user.userInfo.loginToken = "Yes";
          setDoc(this.$data.reference, this.$data.user);
          this.$router.push(`/passenger/home/${this.$data.user.userInfo.phoneNumber}`);
